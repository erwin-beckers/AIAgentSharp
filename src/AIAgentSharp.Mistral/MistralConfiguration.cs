...
/// <summary>
/// Configuration options for Mistral AI LLM integration.
/// </summary>
public sealed class MistralConfiguration
{
    ...
    /// </summary>
    /// <value>
    /// The API key for accessing Mistral AI services.
    /// </value>
    public string ApiKey { get; init; } = string.Empty;

    /// <summary>
    /// Gets or sets the Mistral AI model to use for completions.
    /// </summary>
    /// <value>
    /// The model name. Default is "mistral-large-latest".
    /// </value>
    /// <remarks>
    /// Common models include:
    /// - mistral-large-latest: Latest and most capable model
    ...
    /// Note: Mistral AI supports function calling via tools parameter.
    /// </remarks>
    ...
    /// </summary>
    /// <value>
    /// The base URL. Default is null (uses Mistral's default).
    /// </value>
    /// <remarks>
    /// Useful for using Mistral-compatible APIs or proxies.
    /// </remarks>
    public string? ApiBaseUrl { get; init; }

    /// <summary>
    /// Gets or sets the organization ID for Mistral API calls.
    /// </summary>
    /// <value>
    /// The organization ID. Default is null.
    /// </value>
    /// <remarks>
    /// Required for enterprise Mistral accounts.
    /// </remarks>
    ...
    public static MistralConfiguration Create(string apiKey)
    {
