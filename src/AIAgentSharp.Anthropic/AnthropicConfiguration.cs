...
/// <summary>
/// Configuration options for Anthropic Claude LLM integration.
/// </summary>
public sealed class AnthropicConfiguration
{
    /// <summary>
    /// Gets or sets the Anthropic Claude model to use for completions.
    /// </summary>
    /// <value>
    /// The model name. Default is "claude-3-5-sonnet-20241022".
    /// </value>
    /// <remarks>
    ...
    /// </remarks>
    public string Model { get; init; } = "claude-opus-4-1-20250805";
    ...
    /// </summary>
    /// <value>
    /// The temperature value between 0.0 and 1.0. Default is 0.1.
    /// </value>
    /// <remarks>
    ...
    /// </remarks>
    public float Temperature { get; init; } = 1;
    ...
    /// Note: Anthropic Claude supports function calling via tools parameter.
    /// </remarks>
    ...
    /// </summary>
    /// <value>
    /// The base URL. Default is null (uses Anthropic's default).
    /// </value>
    /// <remarks>
    /// Useful for using Anthropic-compatible APIs or proxies.
    /// </remarks>
    public string? ApiBaseUrl { get; init; }

    /// <summary>
    /// Gets or sets the organization ID for Anthropic API calls.
    /// </summary>
    /// <value>
    /// The organization ID. Default is null.
    /// </value>
    /// <remarks>
    /// Required for enterprise Anthropic accounts.
    /// </remarks>
